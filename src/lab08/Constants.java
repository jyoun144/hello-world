...
public class Constants
{
	...
	public static final String INFO_MSG_INITIAL = "1. Input a whole number between 2 and 9,223,372,036,854,775,807 \n into the text box with a blue border." + 
			                                       "\n\n2. Click the 'Start' button to calculate the number of prime \nnumbers between 2 and the input whole number." +
			                                       "\n\n3. Select option 1, 5, 10, 15 or 20 to set the number of worker threads.";
}
